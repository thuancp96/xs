...
class StringUtils
{
    ...
    {
        return $this->mb_str_pad($string, $length, $filler, STR_PAD_RIGHT); 
    }
    ...
    {
        return $this->mb_str_pad($string, $length, $filler, STR_PAD_LEFT); 
    }
    ...
    {
        if (is_null($length)) {
            $length = ($this->line_length / 2) - (mb_strlen($string) / 2);
        }
