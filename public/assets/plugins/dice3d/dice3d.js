...
var initialize = function initialize() {
    ...
    var result = document.getElementById("dice-rusult");
...
var dice3d = function dice3d(faces, n, callback) {
    ...
    if (faces == 6) {
        ...
        [
            ...
            [{ cx: 8, cy: 8, r: 3 }, { cx: 24, cy: 24, r: 3 }, { cx: 8, cy: 16, r: 3 }, { cx: 24, cy: 16, r: 3 }, { cx: 8, cy: 24, r: 3 }, { cx: 24, cy: 8, r: 3 }]].map(getFace).forEach(function (face) {
