		...
		<div class="col-md-12">
			<div class="checkbox checkbox-primary">
				@if(strpos($function, ",".$chucnang['code'].",") !== false)
					<input id="{{$chucnang['code']}}" checked type="checkbox" onchange="ClickEditFunctions(this,'{{$chucnang['code']}}')">
				@else
					...
					<div style="padding-left: 20px">
						<div class="checkbox checkbox-primary">
							@if(strpos($function,",".$item['code'].",") !== false)
								<input id="{{$item['code']}}" checked type="checkbox" onchange="ClickEditFunctions(this,'{{$item['code']}}')">
							@else
