						...
						<thead>
							<tr>
								<?php 
							    	echo ('<th>' . 'STT' . '</th>');
								    echo ('<th>' . 'Số đánh' . '</th>');
									echo ('<th> Tổng thầu lô (Tổng cược lô)</th>');
								?>
								<!-- <th>Giá trị</th> -->
							</tr>
						</thead>
							...
							<?php
								...
								foreach($TotalBetTodayByNumberARROG as $x => $x_value) {
									if ($x_value > 0){
										...
										echo ('<td class="text_center">' .$x. '</td>');
										echo ('<td class="text_center"><label style="color:red;">' . number_format($x_value) . '</label> <label style="color:black;">('. number_format($TotalBetTodayByNumberARR[$x]) .')</label></td>');
										echo ('</tr>');
						...
						<thead>
							<tr>
								<?php 
									echo ('<th>' . 'STT' . '</th>');
								    echo ('<th>' . 'Số đánh' . '</th>');
									echo ('<th> Tổng thầu đề (Tổng cược đề)</th>');
								?>
								<!-- <th>Giá trị</th> -->
							</tr>
						</thead>
						...
						<thead>
							<tr>
								<?php 
									echo ('<th>' . 'STT' . '</th>');
								    echo ('<th>' . 'Số đánh' . '</th>');
									echo ('<th style="width: 200px"> Tổng thầu nhất (Tổng cược nhất)</th>');
								?>
								<!-- <th>Giá trị</th> -->
							</tr>
						</thead>
