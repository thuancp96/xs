...
<div class="box-body table-responsive no-padding">
	...
	<div class="col-md-12">
		...
		<table class="table table-bordered table-striped dataTable user_percent">
			...
			<thead>
			<tr><th colspan="91" style="text-align:left; padding-left:10px; font-weight:bold"><span class="badge badge-blue">Chuẩn {{$type}} Miền Bắc</span></th>								</tr>
