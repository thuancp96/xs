			...
			<div class="portlet"><!-- /primary heading -->
				<div class="portlet-heading">
					<h3 class="portlet-title text-dark text-uppercase">
						Bảng thao tác cược giới hạn quản lý
					</h3>
	...
	<div class="col-md-12">
		...
		>
            ...
            <?php $count=0;?>
				...
				@if((Auth::user()->roleid == 1 && $location->slug != 50 && $location->slug != 60 && $location->slug != 70 && $location->slug != 80 ) || $location->slug == 60 || $location->slug == 70 || $location->slug == 80)
