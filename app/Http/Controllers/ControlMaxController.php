...
class ControlMaxController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    | Home Controller
    ...
    */
    ...
    public function getIndex(Request $request)
    {
        ...
        if($user->roleid==1)
        {
            return view('admin.control_max.controlmax_vertical',[
    ...
    public function getSuperChangeMaxone($id)
    {
        $chucnangClass = new ChucNang();
        ...
        if($user->roleid==1)
        {
            return view('admin.control_max.controlmax_admin_vertical',[
            'chucnangs'=>$chucnangClass->LoadMenuAndCheckLogin(),
            // 'games'=>GameHelpers::GetAllGameByCusType('A',$user->id,1),
                'user'=>$user,
                'type'=>'A','locationId'=>1]
    ...
    public function postStoreBySuperMaxone(Request $request)
    {
        // $user = Auth::user();
        $user = UserHelpers::GetUserById($request->userid);
        $userParent = UserHelpers::GetAllUserParentV2($user);
